...
2. Go to `File > Scripts` and select either the English or Hebrew version of the QR Generator.
3. Enter your destination URL in the prompt.
4. Select your preferred size and additional options.
5. Click **Make it Magic!** (or **יאללה תענוג!**).
